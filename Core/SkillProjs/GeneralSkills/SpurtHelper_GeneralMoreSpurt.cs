using APIPapyru.Core.SpurtHelpers;

namespace APIPapyru.Core.SkillProjs.GeneralSkills
{
    public class SpurtHelper_GeneralMoreSpurt : ProjSkill_Instantiation
    {
        ...
        public override void OnSkillActive()
        {
            ...
            SpurtHelper.Change(setting.SpurtLength.Invoke(), Projectile.velocity, setting.UseTimeMax.Invoke(), Projectile.Size * 0.2f, setting.DmgConut, (spurt, sb, _) => SpurtHelper.MoreSpurtDraw_Proj(spurt, sb, setting.rotDiff, setting.centerOffset, setting.angleFix));
            if (Main.myPlayer == Player.whoAmI)
            {
